...
import com.ttsq.mobile.http.api.SearchGoodsJingdongApi
...
class JingdongSearchResultFragment: AppFragment<SearchResultActivity>() {

    companion object {

        private const val KEY_WORDS = "KEY_WORDS"

        fun newInstance(keywordStr:String): JingdongSearchResultFragment {
            val taobaoSearchResultFragment = JingdongSearchResultFragment()
            val bundle = Bundle()
    ...
    override fun initView() {
        ...
        goodsList?.let {
            ...
            homeGoodsListAdapter = SearchGoodsListAdapter(requireContext(), platformType = 1)
    ...
    private fun searchGoods() {
        ...
        EasyHttp.get(this)
            .api(SearchGoodsJingdongApi().apply {
                keyword = keywordStr
                min_id = pageIndex
                has_coupon = isYouquan
                sort = paixu
            })
