...
import com.ttsq.mobile.http.api.SearchGoodsPinduoduoApi
...
class PinduoduoSearchResultFragment: AppFragment<SearchResultActivity>() {

    companion object {

        private const val KEY_WORDS = "KEY_WORDS"

        fun newInstance(keywordStr:String): PinduoduoSearchResultFragment {
            val taobaoSearchResultFragment = PinduoduoSearchResultFragment()
            val bundle = Bundle()
    ...
    override fun initView() {
        ...
        goodsList?.let {
            ...
            homeGoodsListAdapter = SearchGoodsListAdapter(requireContext(), platformType = 2)
    ...
    private fun searchGoods() {
        ...
        EasyHttp.get(this)
            .api(SearchGoodsPinduoduoApi().apply {
                keyword = keywordStr
                min_id = pageIndex
                is_coupon = isYouquan
                sort = paixu
